...
const url = 'https://mosttechs.com/cash-frenzy-free-coins/';
const currentDate = getCurrentDate();
const dir = 'links-json';
const filePath = path.join(dir, 'cash-frenzy.json');
const htmlFilePath = path.join('_includes', 'cash-frenzy.html');
...
async function main() {
  try {
    ...
    $('a[href*="cashfrenzy.co"], a[href*="bit.ly"], a[href*="haqy.adj.st"]').each((index, element) => {
