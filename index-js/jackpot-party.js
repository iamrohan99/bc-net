...
const url = 'https://mosttechs.com/jackpot-party-casino-free-coins/';
const currentDate = getCurrentDate();
const dir = 'links-json';
const filePath = path.join(dir, 'jackpot-party.json');
const htmlFilePath = path.join('_includes', 'jackpot-party.html');
...
async function main() {
  try {
    ...
    $('a[href*="bit.ly"], a[href*="jackpotpartycasino.jckpt.me"]').each((index, element) => {
