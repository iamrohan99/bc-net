...
const url = 'https://mosttechs.com/8-ball-pool-free-coins/';
const currentDate = getCurrentDate();
const dir = 'links-json';
const filePath = path.join(dir, '8-ball-pool.json');
const htmlFilePath = path.join('_includes', '8-ball-pool.html');
...
async function main() {
  try {
    ...
    $('a[href*="mcgam.es"]').each((index, element) => {
