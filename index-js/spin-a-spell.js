...
const url = 'https://techyhigher.com/spin-a-spell-free-spins/';
const currentDate = getCurrentDate();
const dir = 'links-json';
const filePath = path.join(dir, 'spin-a-spell.json');
const htmlFilePath = path.join('_includes', 'spin-a-spell.html');
...
async function main() {
  try {
    ...
    $('a[href*="magiccoast.forevernine.com"]').each((index, element) => {
