...
const url = 'https://mosttechs.com/zynga-poker-free-chips-link/';
const currentDate = getCurrentDate();
const dir = 'links-json';
const filePath = path.join(dir, 'zynga-poker.json');
const htmlFilePath = path.join('_includes', 'zynga-poker.html');
...
async function main() {
  try {
    ...
    $('a[href*="zynga.live"]').each((index, element) => {
