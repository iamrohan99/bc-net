...
const url = 'https://mosttechs.com/doubleu-casino-free-chips/';
const currentDate = getCurrentDate();
const dir = 'links-json';
const filePath = path.join(dir, 'doubleu-casino.json');
const htmlFilePath = path.join('_includes', 'doubleu-casino.html');
...
async function main() {
  try {
    ...
    $('a[href*="duc.link"]').each((index, element) => {
