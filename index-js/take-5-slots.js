...
const url = 'https://techyhigher.com/take-5-slots-free-coins/';
const currentDate = getCurrentDate();
const dir = 'links-json';
const filePath = path.join(dir, 'take-5-slots.json');
const htmlFilePath = path.join('_includes', 'take-5-slots.html');
...
async function main() {
  try {
    ...
    $('a[href*="t5.w-ga.me"]').each((index, element) => {
