...
const url = 'https://mosttechs.com/lotsa-slots-free-coins/';
const currentDate = getCurrentDate();
const dir = 'links-json';
const filePath = path.join(dir, 'lotsa-slots.json');
const htmlFilePath = path.join('_includes', 'lotsa-slots.html');
