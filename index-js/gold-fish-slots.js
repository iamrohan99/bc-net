...
const filePath = path.join(dir, 'gold-fish-slots.json');
const htmlFilePath = path.join('_includes', 'gold-fish-slots.html');
...
async function main() {
  try {
    ...
    $('a[href*="bit.ly"], a[href*="goldfishcasinoslots.jckpt.me"]').each((index, element) => {
