...
const url = 'https://techyhigher.com/travel-town-free-energy/';
const currentDate = getCurrentDate();
const dir = 'links-json';
const filePath = path.join(dir, 'travel-town.json');
const htmlFilePath = path.join('_includes', 'travel-town.html');
...
async function main() {
  try {
    ...
    $('a[href*="traveltown.onelink.me"], a[href*="bit.ly"], a[href*="traveltown.me"]').each((index, element) => {
    ...
    combinedLinks.forEach(link => {
      ...
      htmlContent += `    <span>Free Energy ${formattedDate}</span>\n`; // Custom text with formatted date
