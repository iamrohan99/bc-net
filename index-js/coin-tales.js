...
const url = 'https://techyhigher.com/coin-tales-free-spins/';
const currentDate = getCurrentDate();
const dir = 'links-json';
const filePath = path.join(dir, 'coin-tales.json');
const htmlFilePath = path.join('_includes', 'coin-tales.html');
