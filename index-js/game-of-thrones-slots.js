...
const url = 'https://mosttechs.com/game-of-thrones-slots-free-coins/';
const currentDate = getCurrentDate();
const dir = 'links-json';
const filePath = path.join(dir, 'game-of-thrones-slots.json');
const htmlFilePath = path.join('_includes', 'game-of-thrones-slots.html');
...
async function main() {
  try {
    ...
    $('a[href*="gotslots.onelink.me"], a[href*="zynga.social"]').each((index, element) => {
