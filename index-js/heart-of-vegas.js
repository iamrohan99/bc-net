...
const url = 'https://mosttechs.com/heart-of-vegas-free-coins/';
const currentDate = getCurrentDate();
const dir = 'links-json';
const filePath = path.join(dir, 'heart-of-vegas.json');
const htmlFilePath = path.join('_includes', 'heart-of-vegas.html');
...
async function main() {
  try {
    ...
    $('a[href*="hovsocial.onelink.me"], a[href*="bit.ly"], a[href*="hov.rocks"]').each((index, element) => {
