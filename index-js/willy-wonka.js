...
const url = 'https://mosttechs.com/willy-wonka-slots-free-coins/';
const currentDate = getCurrentDate();
const dir = 'links-json';
const filePath = path.join(dir, 'willy-wonka.json');
const htmlFilePath = path.join('_includes', 'willy-wonka.html');
