...
const url = 'https://mosttechs.com/scatter-slots-free-coins/';
const currentDate = getCurrentDate();
const dir = 'links-json';
const filePath = path.join(dir, 'scatter-slots.json');
const htmlFilePath = path.join('_includes', 'scatter-slots.html');
...
async function main() {
  try {
    ...
    $('a[href*="tinyurl.com"]').each((index, element) => {
